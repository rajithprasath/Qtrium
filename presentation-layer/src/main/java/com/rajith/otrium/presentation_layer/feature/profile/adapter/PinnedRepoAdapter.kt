...
import com.rajith.otrium.domain_layer.domain.User
...
class PinnedRepoAdapter(private val context: Context) : RecyclerView.Adapter<PinnedRepoAdapter.PinnedRepoViewHolder>() {
    /**
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PinnedRepoViewHolder {
        ...
        val binding: PinnedRepositoryItemBinding = DataBindingUtil.inflate(layoutInflater, R.layout.pinned_repository_item, parent, false)
     ...
     */
    class PinnedRepoViewHolder(private val binding: PinnedRepositoryItemBinding,private val context: Context) : RecyclerView.ViewHolder(binding.root) {
        /**
