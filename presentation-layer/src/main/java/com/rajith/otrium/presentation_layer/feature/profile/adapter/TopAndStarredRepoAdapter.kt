...
class TopAndStarredRepoAdapter (private val context: Context) : RecyclerView.Adapter<TopAndStarredRepoAdapter.TopAndStarredRepoViewHolder>() {
    /**
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TopAndStarredRepoViewHolder {
        ...
        val binding: TopAndStarredRepoItemBinding = DataBindingUtil.inflate(layoutInflater, R.layout.top_and_starred_repo_item, parent, false)
     ...
     */
    class TopAndStarredRepoViewHolder(private val binding: TopAndStarredRepoItemBinding, private val context: Context) : RecyclerView.ViewHolder(binding.root) {
        /**
